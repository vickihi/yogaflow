...
<main class="single-class">
    ...
    $title = get_theme_mod('single_class_banner_title');
    ?>
    ...
    <section class="banner single-class-banner" style="background-image:url('<?php echo esc_url($banner); ?>')"> <!-- All single class pages use the same banner -->
        <div class="container">
            <h1 class="banner-text"><?php echo nl2br(esc_html($title)); ?></h1>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- Instructor -->
                    <div class="d-flex align-items-center gap-2 mb-3">  <!-- Use BS because this block is used only once and simple layout -->
                    ...
                    <div class="class-meta">                           <!-- Use CSS because 'class-meta' is a reusable component -->
                        ...
                        <div class="meta-item">                        <!-- Use CSS because 'class-item' a repeated UI pattern (icon + label)
                    ...
                    <!-- Booking button -->          
                    <a href="<?php echo esc_url(get_theme_mod('class_booking_page_link')); ?>" class="btn booking-btn">
                        Book a Class
                    </a>
