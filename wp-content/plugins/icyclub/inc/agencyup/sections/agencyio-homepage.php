...
if ( ! function_exists( 'icycp_agencyup_slider' ) ) :
	function icycp_agencyup_slider() {
		...
		$hero_image = get_theme_mod('hero_image',ICYCP_PLUGIN_URL .'inc/agencyup/images/heroimg.png');
  ...
  <section class="bs-slider-warraper" id="slider-section">
    ...
    <div class="bs-slide" style="background-image: url(<?php echo $slider_image; ?>);"> 
       <!--item-->
        <!--slide inner-->
        <div class="container">
        	<div class="row align-items-center justify-content-<?php echo $slider_align; ?> text-<?php echo $slider_align; ?>">
		        <div class="col-10 col-md-7 static">
	              <!--slide content area-->
	              <div class="slide-caption">
	              	<span class="slide-subtitle">We are </span>
                 <?php 
